...
# #Exit
# dropown_to_exit = browser.find_elements_by_xpath("//a[@class='dropdown-toggle']/i")[0]
# time.sleep(10)
# dropown_to_exit.click()
# exit_button = browser.find_elements_by_id("logout")[0]
# exit_button.click()



# #Go to profile settings
# profile_options = browser.find_elements_by_class_name("caret")[0]
